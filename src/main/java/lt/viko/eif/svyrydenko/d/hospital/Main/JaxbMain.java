...
import lt.viko.eif.svyrydenko.d.hospital.Util.JaxbUtil;
...
public class JaxbMain {
    public static void main(String[] args) throws Exception {
        ...
        jaxbUtil.transformToXML(hospital, "hospital2.xml");
        System.out.println(hospital.toString());

        //XML to POJO
        Hospital hospital1 = jaxbUtil.transformToPOJO("hospital.xml");
