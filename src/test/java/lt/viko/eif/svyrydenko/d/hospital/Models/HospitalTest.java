...
class HospitalTest {
    ...
    void testToString() throws ParseException {
        ...
        Patient patient2 = new Patient("Peter", "Parker", 28, "+37015947852",
                "peter.park@gmail.com", hospitalRoom2,
                List.of(new Illness( "Common Cold", "Upper respiratory infection",
                        "Fever, cough, sore throat", "Treat with fluids and rest")));
        ...
        Appointment appointment2 = new Appointment( "monitoring", new SimpleDateFormat("yyyy-MM-dd").
                parse(java.time.LocalDate.now().toString()), "No problems found", patient2);

        Doctor doctor1 = new Doctor("Bob", "Stevens", "+37067645456",
                "Physiotherapist", 5000, List.of(appointment1));
        Doctor doctor2 = new Doctor("Alex", "Vivien", "+37065645456",
                "Cardiology", 4000, List.of(appointment2));

        Equipment equipment1 = new Equipment("Patient monitor", 5643, "HospEq",
                "For monitoring", "Utility room");
        Equipment equipment2 = new Equipment("Elliptical", 579, "Precor",
                "Cardio Equipment", "Fitness Center");
        ...
        Assert.assertTrue(hospital.toString().contains(("Clinic")));
    }
}